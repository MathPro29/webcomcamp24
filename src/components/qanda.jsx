    ...
    const qna = [
        {
            ...
            a: "โดยทั่วไปจะเปิดรับสมัครช่วงเดือนธันวาคมถึงมกราคมของทุกปี ติดตามได้ทางเพจหลักของค่ายครับ",
        },
        {
            q: "ต้องมีพื้นฐานด้านการเขียนโปรแกรมไหมถึงจะสมัครได้?",
        ...
        },
        {
            ...
            a: "มีกิจกรรมทั้งด้านวิชาการและสันทนาการ เช่น เวิร์กช็อป การแข่งขันกลุ่ม เกมละลายพฤติกรรม และกิจกรรมกลางคืนสุดมันส์ครับอยากรู้ต้องสมัครเลย",
        },
        {
            q: "ต้องพักค้างคืนไหม?",
            a: "ใช่ครับ ค่ายนี้เป็นค่ายพักค้าง 2 วัน 1 คืน มีที่พักและอาหารให้พร้อมตลอดงาน",
        },
