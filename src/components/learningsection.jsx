    ...
    <section id="topics" className="bg-white py-12 sm:py-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
          {[
            {
              title: "เข้าใจพื้นฐานการสร้างเกม",
              desc:
                "ได้รู้จักความแตกต่างของการสร้างเกมแบบ High-code, Low-code และ No-code พร้อมตัวอย่างแพลตฟอร์มจริงที่สร้างเกมใหญ่ไปจนถึง Scracth และ MakeCode Arcade ที่ง่ายและเหมาะสำหรับผู้เริ่มต้น",
              tag: "Fundamentals",
            },
            {
              title: "ลงมือสร้างเกมด้วย MakeCode Arcade",
              desc:
                "น้องๆจะได้ลองวาดตัวละครเอง ขยับให้มันเดิน กระโดด ยิง หลบ สร้างฉาก สร้างศัตรูเรียนรู้ฟังก์ชันต่างๆ เข้าใจการสร้างระบบเกมเพื่อให้เห็นภาพการทำงานของเกมแบบครบวงจร",
              tag: "Coding",
            },
            {
              title: "ทำโปรเจกต์เกมของตัวเอง",
              desc:
                "ได้สร้างเกมจากไอเดียของตัวเองหนึ่งเกมเต็มๆ ผ่านการพัฒนาแบบเป็นทีม ได้ออกแบบ คิดแนวเกม และนำเสนอผลงานให้คณะกรรมการและเพื่อนๆ ทดลองเล่นเก็บเป็นประสบการณ์และผลงานในพอร์ตของตัวเอง",
              tag: "Project",
            },
